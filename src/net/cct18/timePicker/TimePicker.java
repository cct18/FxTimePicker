...
public class TimePicker extends TextField {
    ...
    private void checkTime(KeyEvent event) {
        ...
        if (text != null && !text.isEmpty()) {
            ...
            if (isDeleting && minutes == null && lastTime != null && lastTime.contains(":") && lastTime.length() - hours.length() == 1) {
    ...
    /**
     * Get the minute of the selected time
     * 
     * @return the minutes
     */
    ...
    /**
     * Return true if the hour has been set
     * 
     * @return true if the hour has been set
     */
    ...
    /**
     * Return true if the minute has been set
     * 
     * @return true if the minute has been set
     */
    ...
    /**
     * Return true if the complete time has been set
     * 
     * @return true if the complete time has been set
     */
